...
// بنبعت كذا صف في استعلام واحد (Multi-row upsert) بدل استعلام منفصل لكل صف.
// السيرفر على Render في أمريكا، وقاعدة البيانات على Supabase في أوروبا،
// فكل رحلة (Round trip) بينهم بتاخد وقت محسوس - لو عندنا مية صف مثلاً
// وبعتناهم كل واحد لوحده، هياخد وقت طويل جدًا وممكن Supabase توقف
// الاستعلام بنفسها (statement timeout). تجميعهم في استعلام واحد (أو كام
// استعلام لو العدد كبير جدًا) بيقلل عدد الرحلات دي بشكل كبير.
